...
from typing import Listimport torch, torchvision
import torch.nn as nn
import torch.nn.functional as F
from torchvision.models.resnet import Bottleneck
import numpy as np
...
class Yolact(nn.Module):
    ...
    def __init__(self):
        ...
        # src_channels = [256, 256, 256, 256, 256, 256]
        # selected_layers : [0, 1, 2, 3, 4, 5]

        self.prediction_layers = nn.ModuleList()
        cfg.num_heads = len(self.selected_layers) #6 #Prediction Module에서 쓰임.
    ...
    def forward(self, x):
        ...
        if cfg.mask_type == mask_type.lincomb and cfg.eval_mask_branch: #True
            with timer.env('proto'):
                ...
                #   proto_x = (n, 256, 69, 69)
                proto_out = self.proto_net(proto_x) # P3를 proto_net에 통과.
                ...
                proto_out = proto_out.permute(0, 2, 3, 1).contiguous() # (n, h, w, channel)로 변환.
        ...
        with timer.env('pred_heads'):
            ...
            for idx, pred_layer in zip(self.selected_layers, self.prediction_layers): #6개 나오는 prediction layers
                pred_x = outs[idx]

...
## cw : @torch.jit.script의 역할 : decorator 함수의 변환을 함수의 선언 부분에 정의해주는 문법
##      바로 밑의 함수를 예로 들면 함수를 실행하기 전에 
##      point_form = torch.jit.script(point_form)을 미리 해주는 것이라 할 수 있다.
...
def point_form(boxes):
    ...
    """
    #cw : from [[cx, cy, w, h]] to [[xmin, ymin, xmax, ymax]]
...
def center_size(boxes):
    ...
    Return:
        boxes: (tensor) Converted xmin, ymin, xmax, ymax form of boxes.
    """
    #cw : from [[xmin, ymin, xmax, ymax]] to [[cx, cy, w, h]]

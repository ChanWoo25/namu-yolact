...
class COCOAnnotationTransform(object):
    ...
    #cw : 호출하면 COCO dataset의 bbox정보를 Python dictionary(각 bbox의 좌표와 클래스를 리스트로 가짐)로 반환한다.
...
class COCODetection(data.Dataset):
    ...
    #cw : img path의 경우 윈도우에 맞게 변경해야 할 수도.
    ...
    def pull_item(self, index):
        ...
        #cw : crowd는 객체가 군중이라 할 정도로 많을 때 individual object로 구분하지 않고 따로 처리 하는것이다.
